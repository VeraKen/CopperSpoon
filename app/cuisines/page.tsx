...
export default function CuisinesPage(){
 ...
 return <main className="directory-page"><header className="recipe-nav"><a className="brand" href="/"><span className="brand-mark">CS</span><span><b>The Copper Spoon</b><small>Recipes · Culture · Dining</small></span></a><div className="directory-header-links"><a href="/kitchen">My Kitchen</a><a className="text-link" href="/">← Home</a></div></header>
