...
import CookingStudio from "../../components/cooking-studio";
...
export default async function RecipePage({params}:{params:Promise<{slug:string}>}){
 ...
 return <main className={`recipe-page ${dessert?"dessert-recipe-page":""}`}><header className="recipe-nav"><a className="brand" href="/"><span className="brand-mark">CS</span><span><b>The Copper Spoon</b><small>Recipes · Culture · Dining</small></span></a><div className="directory-header-links"><a href="/kitchen">My Kitchen</a><a className="text-link" href={dessert?"/desserts":"/cuisines"}>← {dessert?"All desserts":"All cuisines"}</a></div></header>
