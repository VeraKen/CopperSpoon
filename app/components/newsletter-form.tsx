...
export default function NewsletterForm(){
 ...
 async function submit(event:FormEvent<HTMLFormElement>){
  ...
  if(!consent){setStatus("error");setMessage("Please tick the consent box so we can send your recipes.");return;}
  try{
 ...
 return <form className="newsletter-form" onSubmit={submit} noValidate>
  ...
  <label className="consent"><input type="checkbox" name="consent" value="yes"/><span>I agree to receive three Copper Spoon recipes by email every day. I can unsubscribe anytime.</span></label>
